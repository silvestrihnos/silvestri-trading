...
```
  ...
  if (qKey === "Q2") {
    const todayLosses = newTrades.filter(t => {
      const today = new Date().toLocaleDateString("es-AR", { dateStyle: "short" });
      return t.date?.includes(today) && t.pnl < 0;
    });
